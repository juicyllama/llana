...
@Module({
	...
	providers: [Authentication, Encryption, Logger, LoginService, MySQL, Pagination, Query, Roles, Schema, Sort],
	exports: [Authentication, Encryption, Logger, LoginService, MySQL, Pagination, Query, Roles, Schema, Sort],
})
