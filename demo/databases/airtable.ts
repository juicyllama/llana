...
const buildCustomers = async () => {
    ...
    const fields = Object.keys(Customers[0]).map(field => {
...
const buildEmployees = async () => {
    ...
    const fields = Object.keys(Employees[0]).map(field => {
    ...
    const tableRequest = {
        ...
        data:{
            "name": table,
            "fields": [
                { "name": "employeeId", "type": "number", "options": { "precision": 0 }},
                ...fields
            ], 
        },
        headers: {
...
const buildShippers = async () => {
    ...
    const table = 'Shipper'
    const fields = Object.keys(Shippers[0]).map(field => {
    ...
    const tableRequest = {
        ...
        data:  {
            "name": table,
            "fields": [
                { "name": "shipperId", "type": "number", "options": { "precision": 0 }},
                ...fields
            ]
        },
        headers: {
    ...
    const tableRequest = {
        ...
        data:  {
            ...
            "fields": [
                ...
                { "name": "shippedDate", "type": "dateTime", "options": { timeZone,
                    dateFormat: {
                        format: "YYYY-MM-DD",
                        name: "iso",
                    },
                ...
                { "name": "requiredDate", "type": "dateTime", "options": { 
                    timeZone,
                    dateFormat: {
                        format: "YYYY-MM-DD",
                        name: "iso",
...
const build = async (table: string, tableRequest: axios.AxiosRequestConfig<any>, recordsRequest: axios.AxiosRequestConfig<any>) => {
